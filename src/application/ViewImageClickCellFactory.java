...
public class ViewImageClickCellFactory implements Callback<TableColumn, TableCell> {

    private final EventHandler<Event> click;

    public ViewImageClickCellFactory(EventHandler click) {
        this.click = click;
    }
                    ...
                    protected void updateItem(FavoriteImage item,
                        ...
                        if (empty) {
                            ...
                            /*Image image = new Image(
                                    getClass().getResourceAsStream(
                                            item.getFavoriteImage()));*/
                           Image image = new Image("file:images/view.jpg");
