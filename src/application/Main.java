...
public class Main extends Application {
    ...
    public static LocalDate installDates;
    public static LocalDate activDates;
    ...
    AllocatedPackages packagesAllocated;
	...
	public void start(Stage stage) {
		...
		parentWindow = stage;
		try {
			root = FXMLLoader.load(getClass().getResource("view/subscriberInfo.fxml"));
			...
			addSubs = (Button) scene.lookup("#addSubs");
							...
							try {
								...
								if (value != null) {
				                	...
				                	for(int i=0; i<tokens.length; i++){
				                		...
				                		areaNames = tokens[2].substring(1);
				                    	phoneNumbers = tokens[3].substring(1);
				                    	emails = tokens[4].substring(1);
				                    	stbCodes = tokens[5].substring(1);
				            		...
				            		for(int i=0; i<token.length; i++){
				                		...
				                		installDates = LocalDate.parse(token[0],formatter);
				                		activDates = LocalDate.parse(token[1],formatter);
				                		employees = token[2];
				            		}
           ...
           /* tableview.setRowFactory(tv -> {
                ...
                row.setOnMouseClicked(event -> {
                    if (event.getClickCount() == 1 && (!row.isEmpty())) {
                    	...
                    	regNumbers = clickedRow.get(1).toString();
                    	customerNames = clickedRow.get(2).toString();
                    	areaNames = clickedRow.get(3).toString();
                    	contacts = clickedRow.get(4).toString();
                    	stbCodes = clickedRow.get(5).toString();
                    	stbTypes = clickedRow.get(6).toString();
                    	serialNumbers = clickedRow.get(7).toString();
                    	macAddresss = clickedRow.get(8).toString();
                    	installDates = clickedRow.get(9).toString();
                    	activDates = clickedRow.get(10).toString();
                    	employees = clickedRow.get(11).toString();
                    	
                    	FXMLLoader loader = new FXMLLoader(getClass().getResource("view/editsubscriber.fxml"));
						System.out.println("DATA TO BE SENT"+regNumbers);
						/*EditController controller = 
                    		    ((FXMLLoader) loader).<EditController>getController();////////
						 try {
							Parent root1 = (Parent) loader.load();
						} catch (Exception e1) {
							// TODO Auto-generated catch block
						...
						EditController controller = loader.getController(); 
                    		 //controller.initData(regNumber,customerName,areaName,contact,stbCode,stbType,
                    			//	  serialNumber, macAddress,installDate,activDate,employee);
                    		  //controller.initData(clickedRow.get(1).toString());
        	            //printRow(clickedRow);
        	           // System.out.println("CONTENT OF SELECTED ROW::\n"+customerName);
        	           // System.out.println("CONTENT OF SELECTED ROW::\n"+regNumber);
			...
			*/
			addSubs.setOnAction(new EventHandler<ActionEvent>() {
				
			    @Override public void handle(ActionEvent e) {
			    	try {
			            
			            Parent root = FXMLLoader.load(getClass().getResource("view/addsubscriber.fxml"));
			            Stage mainStage;
	        ...
	        packageSetup.setOnAction(new EventHandler<ActionEvent>() {
			    ...
			    @Override public void handle(ActionEvent e) {
			    	try {
			    		...
			    		System.out.println("LOADING PACKAGE SETUP PAGE");
			            Parent root = FXMLLoader.load(getClass().getResource("view/allocatePackages.fxml"));
			            Stage mainStage = parentWindow;
	...
	public void buildData(){
          ...
          try{
            ...
            String SQL = "SELECT * from subscriber_info";
            //ResultSet
               ...
               // TableColumn col = new TableColumn(rs.getMetaData().getColumnName(i+1));
                ...
                col1.setCellValueFactory(new Callback<CellDataFeatures<ObservableList,String>,ObservableValue<String>>(){  
                    ...
                    public ObservableValue<String> call(CellDataFeatures<ObservableList, String> param) { 
                    	...
                    	gettingLastId = Integer.parseInt(param.getValue().get(j).toString()); 
                ...
                TableColumn col = new TableColumn("Register Name");	
                ...
                TableColumn col = new TableColumn("Customer Name");
                col.setCellValueFactory(new Callback<CellDataFeatures<ObservableList,String>,ObservableValue<String>>(){  
                ...
                TableColumn col = new TableColumn("Area Name");	
                col.setCellValueFactory(new Callback<CellDataFeatures<ObservableList,String>,ObservableValue<String>>(){  
                ...
                TableColumn col = new TableColumn("Phone Number");
                col.setCellValueFactory(new Callback<CellDataFeatures<ObservableList,String>,ObservableValue<String>>(){  
                ...
                TableColumn col = new TableColumn("Email");
                col.setCellValueFactory(new Callback<CellDataFeatures<ObservableList,String>,ObservableValue<String>>(){  
                ...
                TableColumn col = new TableColumn("STB Code");	
                col.setCellValueFactory(new Callback<CellDataFeatures<ObservableList,String>,ObservableValue<String>>(){  
                ...
                TableColumn col = new TableColumn("STB Type");
                col.setCellValueFactory(new Callback<CellDataFeatures<ObservableList,String>,ObservableValue<String>>(){  
                ...
                TableColumn col = new TableColumn("Serial Number");
                col.setCellValueFactory(new Callback<CellDataFeatures<ObservableList,String>,ObservableValue<String>>(){  
                ...
                TableColumn col = new TableColumn("Mac Address");
                col.setCellValueFactory(new Callback<CellDataFeatures<ObservableList,String>,ObservableValue<String>>(){  
                ...
                TableColumn col = new TableColumn("Install Date");
                col.setCellValueFactory(new Callback<CellDataFeatures<ObservableList,String>,ObservableValue<String>>(){  
                ...
                TableColumn col = new TableColumn("Activated Date");
                col.setCellValueFactory(new Callback<CellDataFeatures<ObservableList,String>,ObservableValue<String>>(){  
	...
	public void subsInfoPage(Stage mainStage){
		...
		try {
			...
			addSubs = (Button) mainStage.getScene().lookup("#addSubs");
			boxImage = (ImageView) mainStage.getScene().lookup("#boximage");
			Image image = new Image("file:images/logo.jpg");
            boxImage.setImage(image);
            hash = new Text();
					...
					try {
						...
						//root = FXMLLoader.load(getClass().getResource("view/viewInfo.fxml"));
						 FXMLLoader loader = new FXMLLoader(getClass().getResource("view/viewInfo.fxml"));
	                    	...
	                    	controller.initData(regNumbers,customerNames,areaNames,phoneNumbers,emails,stbCodes,stbTypes,
	                    		  serialNumbers,macAddresss,installDates,activDates,employees);
